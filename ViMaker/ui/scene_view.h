...
namespace nui
{
  ...
  public:
      ...
      mLight(nullptr), mSize(800, 600)
    {
      ...
      mShader->load("../../../../ViMaker/shaders/vs.shader", "../../../../ViMaker/shaders/fs_pbr.shader");
    ...
    nelems::Camera* get_camera() { return mCamera.get(); }
    ...
    void setCamera(std::shared_ptr<nelems::Camera> camera) {
        mCamera = camera;
    }
